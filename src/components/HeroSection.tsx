        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left space-y-8">
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-3">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-xl border border-border bg-surface-elevated text-sm">
              ...
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-xl border border-primary/30 bg-primary/5 text-sm">
          ...
          <div className="hidden lg:flex justify-center">
            <img
              ...
              alt="AI freelancing workflow illustration showing a professional using AI tools for automation, analytics, and content creation"
              width={580}
              height={435}
